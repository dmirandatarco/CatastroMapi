...
class FichaBienCulturalEdit extends Component
{
    ...
    public function mount(Ficha $fichaanterior)
    {
        ...
        $this->tipo_partida1         = $fichaanterior?->sunarpbiencultural?->tipo_partida;
        $this->nume_partida1         = $fichaanterior?->sunarpbiencultural?->nume_partida;
        $this->fojas1                = $fichaanterior?->sunarpbiencultural?->fojas;
        $this->asiento1              = $fichaanterior?->sunarpbiencultural?->asiento;
        $this->fecha_inscripcion1    = $fichaanterior?->sunarpbiencultural?->fecha_inscripcion;
    ...
    public function register()
    {
        try {
            ...
            $this->validate([
                ...
                'observacion1'                   => 'nullable|max:1000',
